...
public class BevShop implements BevShopInterface {
	...
	public void processCoffeeOrder(String bevName, DrinkSizes size, boolean extraShot, boolean extraSyrup) {
		
		getCurrentOrder().addNewBeverage(bevName, size, extraShot, extraSyrup);
		
	}
	
	public void processAlcoholOrder(String bevName, DrinkSizes size) {
	...
	public void processSmoothieOrder(String bevName, DrinkSizes size, int numOfFruits, boolean addProtein) {
